    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="javascript:avoid(0);">Question 3 <span class="sr-only">(current)</span></a></li>
        ...
        <div class="container">
            <div class="alert alert-info">
                Question 3. Write a query in SQL and display results in PHP to find all goals scored on the second half. (Please note that a Soccer game last two halves of 45 minutes each. The query should show goals marked after minute 45. Columns: Team name, Player name, Goal Time)
            </div>
