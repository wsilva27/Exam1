    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="javascript:avoid(0);">Question 4 <span class="sr-only">(current)</span></a></li>
        ...
        <div class="container">
            <div class="alert alert-info">
                Question 4. Write a query in SQL and display results in PHP to find the player along with his team and jersey number who scored the first goal on each match. (Columns: Team Name, Player Name, Jersey Number, Match Date, Goal Time)
            </div>
        ...
        <?php
            ...
            $sql = 'SELECT
                        ...
                        DATE_FORMAT(M.MATCH_DATE, "%m/%d/%Y") AS MATCH_DATE, MIN(S.GOAL_TIME) AS GOAL_TIME
                    FROM
                        SCORE S
                    INNER JOIN
                        PLAYER P
